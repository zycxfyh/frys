...
export class AlibabaService extends BaseService {
  constructor(options = {}) {
    ...
    this.apiKey =
      options.apiKey || this.getConfig('ai.providers.alibaba.apiKey');
    this.timeout = options.timeout || 30000;
    this.maxRetries = options.maxRetries || 3;

    // 测试模式检测
    this.isTestMode =
      this.apiKey === 'test-alibaba-key' || this.apiKey?.startsWith('test-');
