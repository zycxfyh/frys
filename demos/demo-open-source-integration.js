  ...
  for (const service of services) {
    try {
      ...
      if (result && typeof result === 'object') {
        console.log(
          `${service.emoji} ${service.description}: ${result.constructor.name}`,
        );
      } else {
        console.log(
          `${service.emoji} ${service.description}: ${typeof result}`,
        );
      }
    } catch (error) {
  ...
  for (const service of businessServices) {
    try {
      ...
      if (resolvedService && typeof resolvedService === 'object') {
        console.log(
          `${service.emoji} ${service.description}: ${resolvedService.constructor.name}`,
        );
      } else {
        console.log(
          `${service.emoji} ${service.description}: ${typeof resolvedService}`,
        );
      }
    } catch (error) {
      console.log(`❌ ${service.description}: 失败 - ${error.message}`);
